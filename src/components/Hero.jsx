    ...
    >
      <div className=" grid md:grid-cols-2 max-w-[1240px] m-auto ">
        <div className=" flex flex-col justify-center md:items-start w-full px-2 py-8">
          ...
          <p className=" text-2xl py-3">This is our Tech Brand</p>
          <button className="py-3 px-6 sm:w-[60%] my-3">Get Stated</button>
        </div>
        <div>
          <img className=" w-full" src={bgImg} />
        </div>
        <div className=" absolute flex flex-col py-8 md:min-w-[720px] bottom-[5%] mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200 border border-slate-300 rounded-xl text-center shadow-xl ">
          <p>Data Services</p>
